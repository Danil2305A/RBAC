...
public class CommandRegistry {
        ...
        public UserCommands(CommandParser parser) {
            ...
            parser.registerCommand("user-search", "Search users by filters",
                    (scanner, system) -> {
                        ...
                        System.out.print("Select filter number (default 1) and enter filter key: ");
                        int filterNumber = scanner.nextInt();
                        String filterKey = "";
                        if (scanner.hasNext()) {
                            filterKey = scanner.next();
                        }
                        ...
                        switch (filterNumber) {
                            ...
                            default -> filter = UserFilters.byUsername(filterKey);
                        }
        ...
        public PermissionCommands(CommandParser parser) {
            ...
            parser.registerCommand("permissions-check", "Check if user has specific permission",
                    (scanner, system) -> {
                        ...
                        String permissionName = scanner.next();

                        System.out.println("Enter permission resource: ");
                        String permissionResource = scanner.next();
    ...
    private static class ServiceCommands {
        public ServiceCommands(CommandParser parser) {
